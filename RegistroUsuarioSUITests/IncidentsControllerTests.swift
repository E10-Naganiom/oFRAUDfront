...
class MockIncidentsClient: IncidentsClient {
    ...
    override func GetHistorial(id: Int) async throws -> [IncidentFormResponse] {
    ...
    override func GetFeed() async throws -> [IncidentFormResponse] {
        guard TokenStorage.get(identifier: "accessToken") != nil else {
            throw URLError(.userAuthenticationRequired)
        }
    ...
    override func GetEstatus(id: Int) async throws -> String {
        guard TokenStorage.get(identifier: "accessToken") != nil else {
            throw URLError(.userAuthenticationRequired)
        }
    ...
    override func GetStats() async throws -> StatsResponse {
        guard TokenStorage.get(identifier: "accessToken") != nil else {
            throw URLError(.userAuthenticationRequired)
        }
