...
struct CategoriesControllerTests {
    ...
    @Test func testGetNivelRiesgoFailureNoAuth() async throws {
        ...
        let tokenExists = TokenStorage.get(identifier: "accessToken") != nil
        print("Token despues de delete: \(tokenExists)")
        ...
        do {
            ...
            print("Codigo de error: \(urlError.code.rawValue)")
...
class MockCategoriesClient: CategoriesClient {
    ...
    override func GetAllCategories() async throws -> [CategoryFormResponse] {
    ...
    override func GetNivelRiesgo(id: Int) async throws -> String {
        guard TokenStorage.get(identifier: "accessToken") != nil else {
            throw URLError(.userAuthenticationRequired)
        }
    ...
    override func GetStatsCats(id: Int) async throws -> Int {
        guard TokenStorage.get(identifier: "accessToken") != nil else {
            throw URLError(.userAuthenticationRequired)
        }
